...
<div class="flex flex-row w-full h-screen text-white">
    ...
    <div class="w-2/3 m-2 flex flex-row">
        <div class="w-1/2 flex flex-col">
            <div class="h-1/3 m-1 bg-green-700 bg-opacity-50 rounded-md">
        ...
        <div class="w-1/2 flex flex-col">
            ...
            <div class="h-2/3 m-1 bg-green-700 bg-opacity-50 rounded-md">
                <Chat/>
            </div>
        </div>
    </div>
